...
# The agent takes a user's question, generates a Flyte 2-compatible Python script using that input and the Flyte 2 documentation as context,
# and executes the code in an isolated container. If the execution fails, the agent reflects on the error and retries
