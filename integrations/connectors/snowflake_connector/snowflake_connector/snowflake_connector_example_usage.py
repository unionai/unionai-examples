...
import pandas as pd
import union
from flytekit import ImageSpec, Secret, StructuredDataset, task, workflow
...
def write_table() -> union.StructuredDataset:
    ...
    return union.StructuredDataset(dataframe=df, uri=uri)


@union.workflow
def wf() -> union.StructuredDataset:
