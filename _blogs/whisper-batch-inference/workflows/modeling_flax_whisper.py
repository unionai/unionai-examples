...
class FlaxWhisperEncoderLayer(nn.Module):
    ...
    def setup(self) -> None:
        ...
        self.self_attn_layer_norm = layers.LayerNorm(
        ...
        self.final_layer_norm = layers.LayerNorm(
            dtype=self.dtype, epsilon=1e-05, params_dtype=self.params_dtype
        )
...
class FlaxWhisperDecoder(nn.Module):
    ...
    def setup(self) -> None:
        ...
        self.layers = FlaxWhisperDecoderLayerCollection(
            self.config, dtype=self.dtype, params_dtype=self.params_dtype
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        module = self.module_class(
            config=config, dtype=dtype, params_dtype=params_dtype, **kwargs
        )
        super().__init__(
            config,
            module,
